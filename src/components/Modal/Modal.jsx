...
import GetTableInfo from '../../hooks/getTableInfo';
import styles from "./index.module.scss"
//import styles1 from "../Modal/index.module.scss"
import { ErrorTime } from './ModalStyles';
import { useEffect, useState } from 'react';
export default function ModalWindow({ open, onClose, clickedElement, clickedDay, month, year }) {
  if (!open) return null;
  const portalElement = document.getElementById('portal')
  const { handleBook, handleTime, oneUser, isError, currentDate, errorMessage, handleBookTableForDay, time, isConfirm, isBooked } = GetTableInfo({ clickedElement, onClose, month, year, clickedDay })
    ...
    <>
      <div className={styles.modal} onClick={handleOverlayClick}>
        {!isBooked ? (
          ...
          <div className={styles.smodal__inner}>
            <div className={styles.smodal__background}>   </div>
            <h1 className={styles.smodal__title}>
              Congratulations!
            </h1>
            <div className={styles.smodal__text}>
              <p className={styles.smodal__about}>
            ...
            <button className={styles.smodal__btn}
