import {
  es_default,
  init_es
} from "./chunk-SK6FJWDP.js";
import {
  ApolloLink,
  bundle_esm_default,
  execute
} from "./chunk-OHXJYNU3.js";
import {
  InvariantError,
...
} from "./chunk-5P4TCXY5.js";
import {
  BREAK,
  init_visitor,
  visit
} from "./chunk-IPBEV73K.js";
...
var ObservableQuery = function(_super) {
  ...
  ObservableQuery2.prototype.getCurrentResult = function() {
    ...
    return __assign(__assign({}, result), { partial });
  };
        ...
        if (_this.lastError || _this.isDifferentFromLastResult(result)) {
          ...
          if (queryManager.transform(query_1).hasClientExports) {
            queryManager.getLocalState().addExportedVariables(query_1, variables).then(function(variables2) {
              ...
              if (!result.loading && previousResult_1 && fetchPolicy_1 !== "cache-only" && queryManager.transform(query_1).serverQuery && !equal(previousVariables, variables2)) {
                _this.refetch();
              } else {
...
var QueryManager = function() {
        ...
        switch (_f.label) {
          ...
          case 2:
            ...
            return [2, new Promise(function(resolve, reject) {
              var storeResult;
              var error;
              self.getObservableFromLink(mutation, __assign(__assign({}, context), { optimisticResponse }), variables, false).subscribe({
                next: function(result) {
                  ...
                  if (isNonEmptyArray(refetchQueries)) {
                    refetchQueries.forEach(function(refetchQuery) {
                      if (typeof refetchQuery === "string") {
                        self.queries.forEach(function(_a2) {
                          var observableQuery = _a2.observableQuery;
  ...
  QueryManager2.prototype.markQueryResult = function(queryId, result, _a, fetchMoreForQueryId) {
  ...
  QueryManager2.prototype.startGraphQLSubscription = function(_a) {
    ...
    var makeObservable = function(variables2) {
      return _this.getObservableFromLink(query, {}, variables2, false).map(function(result) {
        if (!fetchPolicy || fetchPolicy !== "no-cache") {
          _this.dataStore.markSubscriptionResult(result, query, variables2);
          _this.broadcastQueries();
        }
...
var DataStore = function() {
  ...
  DataStore2.prototype.markQueryResult = function(result, document, variables, fetchMoreForQueryId, ignoreErrors) {
  ...
  DataStore2.prototype.markSubscriptionResult = function(result, document, variables) {
    if (!graphQLResultHasError(result)) {
      this.cache.write({
        result: result.data,
...
export {
  ...
  ObservableQuery,
  ApolloClient,
  bundle_esm_default2 as bundle_esm_default
};
...
tslib/tslib.es6.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-3RLZKQDL.js.map
